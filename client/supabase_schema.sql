...
-- 16. DISABLE ROW-LEVEL SECURITY (RLS) ON ALL TABLES
-- This allows client-side direct database access for the serverless configuration.
...
ALTER TABLE public.discount_types DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.payment_methods DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.customers DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.orders DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.inventory_logs DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.stock_adjustment_reasons DISABLE ROW LEVEL SECURITY;

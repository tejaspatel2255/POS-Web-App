...
- **POS Terminal**: Live checkout shopping basket with category pills and SKU search. Stock-aware checkout (prevents selling out-of-stock items), loyalty point calculation, fixed/percentage discounts, split payment options, and invoice printing templates.
...
3. Click **New query** and paste the contents of **[supabase_schema.sql](./client/supabase_schema.sql)**.
